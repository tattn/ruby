struct JITFuncs
{
	...
	Function *vm_caller_setup_arg_block_extern;
	Function *vm_pop_frame_extern;
	Function *vm_search_method_extern;
	...
	Function *vm_getinstancevariable_extern;
	Function *vm_setinstancevariable_extern;
	Function *rb_cvar_get;
	Function *vm_get_cvar_base;
	Function *rb_vm_get_cref;
	Function *rb_cvar_set;
	Function *vm_get_ev_const_extern;
